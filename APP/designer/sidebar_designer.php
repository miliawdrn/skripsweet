    ...
    <div class="main-container d-flex">
        <div class="sidebar" id="side_nav">
            ...
            <ul class="list-unstyled px-3 pt-5">
                <li class="active">
                    <a href="dashboard_designer.php" class="text-decoration-none px-3 py-2 d-block"><i class="fas fa-th-large"></i>&nbsp Job Order List</a>
                </li>
                <li class="">
                    <a href="notification_designer.php" class="text-decoration-none px-3 py-2 d-block"><i class="fas fa-bell"></i>&nbsp Notification</a>
                </li>
                <!--
                <li class="">
                ...
                <li class="">
                    <a href="designer_analytics.php" class="text-decoration-none px-3 py-2 d-block"><i class="fas fa-chart-bar"></i>&nbsp Analytics</a>
                </li>
                <li class="">
                    <a href="account_designer.php" class="text-decoration-none px-3 py-2 d-block"><i class="fas fa-user"></i>&nbsp Account</a>
                </li>
                <li class="">
